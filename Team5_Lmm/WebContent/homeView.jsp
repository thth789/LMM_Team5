	...
	<section>
	  ...
	  <div id="templatemo_slider">
        <div class="slider-wrapper theme-orman">
            ...
            <div class ="slider_inmoon"><img id="img1" src="img/1_inmoon_off.png"/></div>
            <div class ="slider_inmoon"><img id="img2" src="img/1_sahoi_off.png"/></div>
            <div class ="slider_inmoon"><img id="img3" src="img/1_science_off.png"/></div>
            <div class ="slider_inmoon"><img id="img4" src="img/1_moonhwa_off.png"/></div>
            <div class ="slider_inmoon"><img id="img5" src="img/1_gita_off.png"/></div>
<!--             <div class="nivo-controlNav-bg"></div> -->
      ...
      <div id="templatemo_main">
       ...
       <div class="mainmenu">
              <img alt="베스트강의" id="best" src="img/1_bestlec_off.png"/>
           <img alt="최신강의" id="latest" src="img/1_lat_off.png"/>
           <img alt="맞춤강의" id="custom" src="img/1_cs_off.png"/>
           <img alt="게시판" id="board" src="img/1_board_off.png"/>
        </div>
